...
set(stdout_log "T:/git/LaserChess3DWindows-master/cmake-build-release/external/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-build-out.log")
set(stderr_log "T:/git/LaserChess3DWindows-master/cmake-build-release/external/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  T:/git/LaserChess3DWindows-master/cmake-build-release/external/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-build-*.log")
  endif()
  ...
  set(msg "gtest build command succeeded.  See also T:/git/LaserChess3DWindows-master/cmake-build-release/external/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-build-*.log")
  message(STATUS "${msg}")
endif()
